...
encode_dict = {
    ...
    "seller type":{'Dealer':1,'Individual':2,"Trustmark Dealer":3},
    "transmission type":{'Manual':1,"Automatic":2}
}
...
if (st.button("Predict Price")):
    ...
    transmission_type = encode_dict['transmission type'][transmission_type]

    price = model_pred(fuel_type,transmission_type,engine,seats)
    st.text("Precicted price of the car "+str(price))